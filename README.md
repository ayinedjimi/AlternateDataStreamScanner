...
![Stars](https://img.shields.io/github/stars/ayinedjimi/AlternateDataStreamScanner?style=social) ![Forks](https://img.shields.io/github/forks/ayinedjimi/AlternateDataStreamScanner?style=social) ![Issues](https://img.shields.io/github/issues/ayinedjimi/AlternateDataStreamScanner)
...
**🚀 AlternateDataStreamScanner - Scanner de Flux de Données Alternatifs NTFS** est un projet développé par **Ayi NEDJIMI Consultants**, expert en cybersécurité et intelligence artificielle.
...
```bash
git clone https://github.com/VOTRE_USERNAME/AlternateDataStreamScanner.git
cd AlternateDataStreamScanner
```
